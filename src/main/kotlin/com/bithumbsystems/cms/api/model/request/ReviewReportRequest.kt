...
@Schema(description = "가상자산검토보고서 요청")
...
fun ReviewReportRequest.toEntity(): CmsReviewReport {
    ...
    entity.shareButtonName = shareButtonName ?: VIRTUAL_ASSET_REVIEW_REPORT_TITLE
...
fun ReviewReportRequest.validate(): Boolean {
    return when {
